...
/*
generated at Fri May 10 11:35:55 2013
...
static short _nts_37[] = { _addrj_NT, 0 };
static short _nts_38[] = { _mem4_NT, _rc_NT, 0 };
static short _nts_39[] = { _mr_NT, _con_NT, _con0_NT, 0 };
static short _nts_40[] = { _addr_NT, _con_NT, _con0_NT, 0 };
static short _nts_41[] = { _cmpf_NT, _freg_NT, 0 };
static short _nts_42[] = { _freg_NT, _addr_NT, 0 };
...
/* 251 */	"l %0",	/* cmpf: INDIRF8(addr) */
/* 252 */	"s %0",	/* cmpf: INDIRF4(addr) */
/* 253 */	"s %0",	/* cmpf: CVFF8(INDIRF4(addr)) */
/* 254 */	"p",	/* cmpf: freg */
/* 255 */	"fcomp%0\nfstsw %%ax\nsahf\nje %a\n",	/* stmt: EQF8(cmpf,freg) */
/* 256 */	"fcomp%0\nfstsw %%ax\nsahf\njbe %a\n",	/* stmt: GEF8(cmpf,freg) */
/* 257 */	"fcomp%0\nfstsw %%ax\nsahf\njb %a\n",	/* stmt: GTF8(cmpf,freg) */
...
/* 199 */	"flt: memf",
/* 200 */	"flt: freg",
/* 201 */	"freg: ADDF4(freg,flt)",
/* 202 */	"freg: ADDF8(freg,flt)",
/* 203 */	"freg: DIVF4(freg,flt)",
/* 204 */	"freg: DIVF8(freg,flt)",
/* 205 */	"freg: MULF4(freg,flt)",
/* 206 */	"freg: MULF8(freg,flt)",
/* 207 */	"freg: SUBF4(freg,flt)",
/* 208 */	"freg: SUBF8(freg,flt)",
/* 209 */	"freg: CVFF8(freg)",
/* 210 */	"freg: CVFF4(freg)",
/* 211 */	"stmt: ASGNI4(addr,CVFI4(freg))",
/* 212 */	"reg: CVFI4(freg)",
/* 213 */	"freg: CVIF8(INDIRI4(addr))",
/* 214 */	"freg: CVIF8(reg)",
/* 215 */	"freg: CVIF4(INDIRI4(addr))",
/* 216 */	"freg: CVIF4(reg)",
/* 217 */	"addrj: ADDRGP4",
/* 218 */	"addrj: reg",
/* 219 */	"addrj: mem4",
/* 220 */	"stmt: LABELV",
/* 221 */	"stmt: JUMPV(addrj)",
/* 222 */	"stmt: EQI4(mem4,rc)",
/* 223 */	"stmt: GEI4(mem4,rc)",
/* 224 */	"stmt: GTI4(mem4,rc)",
/* 225 */	"stmt: LEI4(mem4,rc)",
/* 226 */	"stmt: LTI4(mem4,rc)",
/* 227 */	"stmt: NEI4(mem4,rc)",
/* 228 */	"stmt: GEU4(mem4,rc)",
/* 229 */	"stmt: GTU4(mem4,rc)",
/* 230 */	"stmt: LEU4(mem4,rc)",
/* 231 */	"stmt: LTU4(mem4,rc)",
/* 232 */	"stmt: EQI4(reg,mrc)",
/* 233 */	"stmt: GEI4(reg,mrc)",
/* 234 */	"stmt: GTI4(reg,mrc)",
/* 235 */	"stmt: LEI4(reg,mrc)",
/* 236 */	"stmt: LTI4(reg,mrc)",
/* 237 */	"stmt: NEI4(reg,mrc)",
/* 238 */	"stmt: EQU4(reg,mrc)",
/* 239 */	"stmt: GEU4(reg,mrc)",
/* 240 */	"stmt: GTU4(reg,mrc)",
/* 241 */	"stmt: LEU4(reg,mrc)",
/* 242 */	"stmt: LTU4(reg,mrc)",
/* 243 */	"stmt: NEU4(reg,mrc)",
/* 244 */	"stmt: EQI4(BANDU4(mr,con),con0)",
/* 245 */	"stmt: NEI4(BANDU4(mr,con),con0)",
/* 246 */	"stmt: EQI4(BANDU4(CVII2(INDIRI2(addr)),con),con0)",
/* 247 */	"stmt: NEI4(BANDU4(CVII2(INDIRI2(addr)),con),con0)",
/* 248 */	"stmt: EQI4(BANDU4(CVIU2(INDIRI2(addr)),con),con0)",
/* 249 */	"stmt: NEI4(BANDU4(CVIU2(INDIRI2(addr)),con),con0)",
/* 250 */	"stmt: EQI4(BANDU4(CVII1(INDIRI1(addr)),con),con0)",
/* 251 */	"cmpf: INDIRF8(addr)",
/* 252 */	"cmpf: INDIRF4(addr)",
/* 253 */	"cmpf: CVFF8(INDIRF4(addr))",
/* 254 */	"cmpf: freg",
/* 255 */	"stmt: EQF8(cmpf,freg)",
/* 256 */	"stmt: GEF8(cmpf,freg)",
/* 257 */	"stmt: GTF8(cmpf,freg)",
/* 258 */	"stmt: LEF8(cmpf,freg)",
/* 259 */	"stmt: LTF8(cmpf,freg)",
/* 260 */	"stmt: NEF8(cmpf,freg)",
/* 261 */	"stmt: EQF4(cmpf,freg)",
/* 262 */	"stmt: GEF4(cmpf,freg)",
/* 263 */	"stmt: GTF4(cmpf,freg)",
/* 264 */	"stmt: LEF4(cmpf,freg)",
/* 265 */	"stmt: LTF4(cmpf,freg)",
/* 266 */	"stmt: NEF4(cmpf,freg)",
/* 267 */	"freg: DIVF8(freg,CVIF8(INDIRI4(addr)))",
/* 268 */	"freg: DIVF8(CVIF8(INDIRI4(addr)),freg)",
/* 269 */	"freg: DIVF8(freg,CVIF8(CVII2(INDIRI2(addr))))",
/* 270 */	"freg: DIVF8(CVIF8(CVII2(INDIRI2(addr))),freg)",
/* 271 */	"freg: MULF8(freg,CVIF8(INDIRI4(addr)))",
/* 272 */	"freg: MULF8(freg,CVIF8(CVII2(INDIRI2(addr))))",
/* 273 */	"freg: SUBF8(freg,CVIF8(INDIRI4(addr)))",
/* 274 */	"freg: SUBF8(CVIF8(INDIRI4(addr)),freg)",
/* 275 */	"freg: SUBF8(freg,CVIF8(CVII2(INDIRI2(addr))))",
/* 276 */	"freg: SUBF8(CVIF8(CVII2(INDIRI2(addr))),freg)",
/* 277 */	"freg: ADDF8(freg,CVIF8(INDIRI4(addr)))",
/* 278 */	"freg: ADDF8(freg,CVIF8(CVII2(INDIRI2(addr))))",
/* 279 */	"freg: ADDF8(freg,CVFF8(INDIRF4(addr)))",
/* 280 */	"freg: SUBF8(freg,CVFF8(INDIRF4(addr)))",
/* 281 */	"freg: MULF8(freg,CVFF8(INDIRF4(addr)))",
/* 282 */	"freg: DIVF8(freg,CVFF8(INDIRF4(addr)))",
/* 283 */	"freg: LOADF8(memf)",
/* 284 */	"reg: CALLI4(addrj)",
/* 285 */	"reg: CALLU4(addrj)",
/* 286 */	"reg: CALLP4(addrj)",
/* 287 */	"reg: CALLI4(addrj)",
/* 288 */	"reg: CALLU4(addrj)",
/* 289 */	"reg: CALLP4(addrj)",
/* 290 */	"stmt: CALLV(addrj)",
/* 291 */	"stmt: CALLV(addrj)",
/* 292 */	"freg: CALLF4(addrj)",
/* 293 */	"freg: CALLF4(addrj)",
/* 294 */	"stmt: CALLF4(addrj)",
/* 295 */	"stmt: CALLF4(addrj)",
/* 296 */	"freg: CALLF8(addrj)",
/* 297 */	"freg: CALLF8(addrj)",
/* 298 */	"stmt: CALLF8(addrj)",
...
static void _label(NODEPTR_TYPE a) {
	...
	case 4149: /* ASGNI4 */
		...
		if (	/* stmt: ASGNI4(addr,CVFI4(freg)) */
			RIGHT_CHILD(a)->op == 4213 /* CVFI4 */
		) {
...
static void _kids(NODEPTR_TYPE p, int eruleno, NODEPTR_TYPE kids[]) {
	...
	switch (eruleno) {
	case 220: /* stmt: LABELV */
	case 217: /* addrj: ADDRGP4 */
	...
	case 35: /* con: cnst */
		kids[0] = p;
		break;
	case 266: /* stmt: NEF4(cmpf,freg) */
	case 265: /* stmt: LTF4(cmpf,freg) */
	case 264: /* stmt: LEF4(cmpf,freg) */
	case 263: /* stmt: GTF4(cmpf,freg) */
	case 262: /* stmt: GEF4(cmpf,freg) */
	case 261: /* stmt: EQF4(cmpf,freg) */
	case 260: /* stmt: NEF8(cmpf,freg) */
	case 259: /* stmt: LTF8(cmpf,freg) */
	case 258: /* stmt: LEF8(cmpf,freg) */
	case 257: /* stmt: GTF8(cmpf,freg) */
	case 256: /* stmt: GEF8(cmpf,freg) */
	case 255: /* stmt: EQF8(cmpf,freg) */
	case 243: /* stmt: NEU4(reg,mrc) */
	case 242: /* stmt: LTU4(reg,mrc) */
	case 241: /* stmt: LEU4(reg,mrc) */
	case 240: /* stmt: GTU4(reg,mrc) */
	case 239: /* stmt: GEU4(reg,mrc) */
	case 238: /* stmt: EQU4(reg,mrc) */
	case 237: /* stmt: NEI4(reg,mrc) */
	case 236: /* stmt: LTI4(reg,mrc) */
	case 235: /* stmt: LEI4(reg,mrc) */
	case 234: /* stmt: GTI4(reg,mrc) */
	case 233: /* stmt: GEI4(reg,mrc) */
	case 232: /* stmt: EQI4(reg,mrc) */
	case 231: /* stmt: LTU4(mem4,rc) */
	case 230: /* stmt: LEU4(mem4,rc) */
	case 229: /* stmt: GTU4(mem4,rc) */
	case 228: /* stmt: GEU4(mem4,rc) */
	case 227: /* stmt: NEI4(mem4,rc) */
	case 226: /* stmt: LTI4(mem4,rc) */
	case 225: /* stmt: LEI4(mem4,rc) */
	case 224: /* stmt: GTI4(mem4,rc) */
	case 223: /* stmt: GEI4(mem4,rc) */
	case 222: /* stmt: EQI4(mem4,rc) */
	case 208: /* freg: SUBF8(freg,flt) */
	case 207: /* freg: SUBF4(freg,flt) */
	case 206: /* freg: MULF8(freg,flt) */
	case 205: /* freg: MULF4(freg,flt) */
	case 204: /* freg: DIVF8(freg,flt) */
	case 203: /* freg: DIVF4(freg,flt) */
	case 202: /* freg: ADDF8(freg,flt) */
	case 201: /* freg: ADDF4(freg,flt) */
	...
	case 43: /* base: ADDI4(reg,acon) */
		...
		break;
	case 304: /* stmt: RETF8(freg) */
	case 303: /* stmt: RETF4(freg) */
	case 302: /* stmt: RETP4(reg) */
	case 301: /* stmt: RETU4(reg) */
	case 300: /* stmt: RETI4(reg) */
	case 299: /* stmt: CALLF8(addrj) */
	case 298: /* stmt: CALLF8(addrj) */
	case 297: /* freg: CALLF8(addrj) */
	case 296: /* freg: CALLF8(addrj) */
	case 295: /* stmt: CALLF4(addrj) */
	case 294: /* stmt: CALLF4(addrj) */
	case 293: /* freg: CALLF4(addrj) */
	case 292: /* freg: CALLF4(addrj) */
	case 291: /* stmt: CALLV(addrj) */
	case 290: /* stmt: CALLV(addrj) */
	case 289: /* reg: CALLP4(addrj) */
	case 288: /* reg: CALLU4(addrj) */
	case 287: /* reg: CALLI4(addrj) */
	case 286: /* reg: CALLP4(addrj) */
	case 285: /* reg: CALLU4(addrj) */
	case 284: /* reg: CALLI4(addrj) */
	case 283: /* freg: LOADF8(memf) */
	case 252: /* cmpf: INDIRF4(addr) */
	case 251: /* cmpf: INDIRF8(addr) */
	case 221: /* stmt: JUMPV(addrj) */
	case 216: /* freg: CVIF4(reg) */
	case 214: /* freg: CVIF8(reg) */
	case 212: /* reg: CVFI4(freg) */
	case 210: /* freg: CVFF4(freg) */
	case 209: /* freg: CVFF8(freg) */
	...
	case 118: /* stmt: ASGNI4(addr,ADDI4(mem4,con1)) */
		...
		break;
	case 211: /* stmt: ASGNI4(addr,CVFI4(freg)) */
	...
	case 137: /* stmt: ASGNI4(addr,BCOMI4(mem4)) */
		...
		kids[1] = LEFT_CHILD(RIGHT_CHILD(p));
		break;
	case 253: /* cmpf: CVFF8(INDIRF4(addr)) */
	case 215: /* freg: CVIF4(INDIRI4(addr)) */
	case 213: /* freg: CVIF8(INDIRI4(addr)) */
	...
	case 159: /* reg: CVII4(INDIRI1(addr)) */
		...
		break;
	case 245: /* stmt: NEI4(BANDU4(mr,con),con0) */
	case 244: /* stmt: EQI4(BANDU4(mr,con),con0) */
		kids[0] = LEFT_CHILD(LEFT_CHILD(p));
		kids[1] = RIGHT_CHILD(LEFT_CHILD(p));
		kids[2] = RIGHT_CHILD(p);
		break;
	case 250: /* stmt: EQI4(BANDU4(CVII1(INDIRI1(addr)),con),con0) */
	case 249: /* stmt: NEI4(BANDU4(CVIU2(INDIRI2(addr)),con),con0) */
	case 248: /* stmt: EQI4(BANDU4(CVIU2(INDIRI2(addr)),con),con0) */
	case 247: /* stmt: NEI4(BANDU4(CVII2(INDIRI2(addr)),con),con0) */
	case 246: /* stmt: EQI4(BANDU4(CVII2(INDIRI2(addr)),con),con0) */
		kids[0] = LEFT_CHILD(LEFT_CHILD(LEFT_CHILD(LEFT_CHILD(p))));
		kids[1] = RIGHT_CHILD(LEFT_CHILD(p));
		kids[2] = RIGHT_CHILD(p);
		break;
	case 282: /* freg: DIVF8(freg,CVFF8(INDIRF4(addr))) */
	case 281: /* freg: MULF8(freg,CVFF8(INDIRF4(addr))) */
	case 280: /* freg: SUBF8(freg,CVFF8(INDIRF4(addr))) */
	case 279: /* freg: ADDF8(freg,CVFF8(INDIRF4(addr))) */
	case 277: /* freg: ADDF8(freg,CVIF8(INDIRI4(addr))) */
	case 273: /* freg: SUBF8(freg,CVIF8(INDIRI4(addr))) */
	case 271: /* freg: MULF8(freg,CVIF8(INDIRI4(addr))) */
	case 267: /* freg: DIVF8(freg,CVIF8(INDIRI4(addr))) */
		kids[0] = LEFT_CHILD(p);
		kids[1] = LEFT_CHILD(LEFT_CHILD(RIGHT_CHILD(p)));
		break;
	case 274: /* freg: SUBF8(CVIF8(INDIRI4(addr)),freg) */
	case 268: /* freg: DIVF8(CVIF8(INDIRI4(addr)),freg) */
		kids[0] = LEFT_CHILD(LEFT_CHILD(LEFT_CHILD(p)));
		kids[1] = RIGHT_CHILD(p);
		break;
	case 278: /* freg: ADDF8(freg,CVIF8(CVII2(INDIRI2(addr)))) */
	case 275: /* freg: SUBF8(freg,CVIF8(CVII2(INDIRI2(addr)))) */
	case 272: /* freg: MULF8(freg,CVIF8(CVII2(INDIRI2(addr)))) */
	case 269: /* freg: DIVF8(freg,CVIF8(CVII2(INDIRI2(addr)))) */
		kids[0] = LEFT_CHILD(p);
		kids[1] = LEFT_CHILD(LEFT_CHILD(LEFT_CHILD(RIGHT_CHILD(p))));
		break;
	case 276: /* freg: SUBF8(CVIF8(CVII2(INDIRI2(addr))),freg) */
	case 270: /* freg: DIVF8(CVIF8(CVII2(INDIRI2(addr))),freg) */
		kids[0] = LEFT_CHILD(LEFT_CHILD(LEFT_CHILD(LEFT_CHILD(p))));
		kids[1] = RIGHT_CHILD(p);
		break;
	default:
