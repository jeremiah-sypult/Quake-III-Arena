...
/*
generated at Fri May 10 11:35:54 2013
...
/* 206 */	"fcmped %%f%0,%%f%1; nop; fbue",	/* rel: EQF8(reg,reg) */
/* 207 */	"fcmpes %%f%0,%%f%1; nop; fbue",	/* rel: EQF4(reg,reg) */
/* 208 */	"fcmped %%f%0,%%f%1; nop; fbuge",	/* rel: GEF8(reg,reg) */
/* 209 */	"fcmpes %%f%0,%%f%1; nop; fbuge",	/* rel: GEF4(reg,reg) */
/* 210 */	"fcmped %%f%0,%%f%1; nop; fbug",	/* rel: GTF8(reg,reg) */
/* 211 */	"fcmpes %%f%0,%%f%1; nop; fbug",	/* rel: GTF4(reg,reg) */
/* 212 */	"fcmped %%f%0,%%f%1; nop; fbule",	/* rel: LEF8(reg,reg) */
/* 213 */	"fcmpes %%f%0,%%f%1; nop; fbule",	/* rel: LEF4(reg,reg) */
/* 214 */	"fcmped %%f%0,%%f%1; nop; fbul",	/* rel: LTF8(reg,reg) */
/* 215 */	"fcmpes %%f%0,%%f%1; nop; fbul",	/* rel: LTF4(reg,reg) */
/* 216 */	"fcmped %%f%0,%%f%1; nop; fbne",	/* rel: NEF8(reg,reg) */
/* 217 */	"fcmpes %%f%0,%%f%1; nop; fbne",	/* rel: NEF4(reg,reg) */
/* 218 */	"%0 %a; nop\n",	/* stmt: rel */
/* 219 */	"# LOADD\n",	/* reg: LOADF8(reg) */
/* 220 */	"# NEGD\n",	/* reg: NEGF8(reg) */
...
/* 206 */	0,	/* fcmped %%f%0,%%f%1; nop; fbue */
/* 207 */	0,	/* fcmpes %%f%0,%%f%1; nop; fbue */
/* 208 */	0,	/* fcmped %%f%0,%%f%1; nop; fbuge */
/* 209 */	0,	/* fcmpes %%f%0,%%f%1; nop; fbuge */
/* 210 */	0,	/* fcmped %%f%0,%%f%1; nop; fbug */
/* 211 */	0,	/* fcmpes %%f%0,%%f%1; nop; fbug */
/* 212 */	0,	/* fcmped %%f%0,%%f%1; nop; fbule */
/* 213 */	0,	/* fcmpes %%f%0,%%f%1; nop; fbule */
/* 214 */	0,	/* fcmped %%f%0,%%f%1; nop; fbul */
/* 215 */	0,	/* fcmpes %%f%0,%%f%1; nop; fbul */
/* 216 */	0,	/* fcmped %%f%0,%%f%1; nop; fbne */
/* 217 */	0,	/* fcmpes %%f%0,%%f%1; nop; fbne */
/* 218 */	1,	/* %0 %a; nop\n */
/* 219 */	1,	/* # LOADD\n */
/* 220 */	1,	/* # NEGD\n */
/* 221 */	1,	/* # ASGNB\n */
